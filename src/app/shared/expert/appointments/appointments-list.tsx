...
import AppintmentListTab from "./components/tab";
export enum AppointmentType {
  Upcomming = "Upcomming",
  History = "History",
}
export default function AppointmentsList() {
  const [activeTab, setActiveTab] = useState<AppointmentType>(
    AppointmentType.Upcomming
  );
  ...
  const appoitmentsList = useFetchData(
    ...
    activeTab === AppointmentType.Upcomming
      ...
      await postMutation.mutateAsync({
        ...
        onSuccess: () => {
          queryClient.invalidateQueries({
            queryKey: [queryKeys.getAllAppointmentListEx],
          });
