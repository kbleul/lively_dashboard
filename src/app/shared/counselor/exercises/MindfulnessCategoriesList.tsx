...
const MindfulnessCategoriesList = () => {
  const { openModal } = useModal();

  const headers = useGetHeaders({ type: "Json" });

  const categoriesList = useFetchData(
    [queryKeys.getAllMindfulnessCategory],
        ...
        {categoriesList.data.data &&
          categoriesList.data.data.map((category: any) => (
            ...
            >
              ...
              <div className="p-4">
                <Title as="h6" className="text-lg font-medium h-14">
                ...
                >
                  <Link
                    href={routes.counselor["mindfulness-exercises"](
                      category.id
                    )}
                  >
                    View
...
export default MindfulnessCategoriesList;
